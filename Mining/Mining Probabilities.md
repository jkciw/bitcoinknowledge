...
<br>
The probability mass function (PMF) is given by<br>![](images/miningprob_eq2.png)<br>
...
the variance in the mining reward received by the miner can be expressed as <br> ![](images/miningprob_eq5.png)<br> 
 The standard deviation, a measure of the amount of variation a *random variable* $X$ has about its mean, of the mining reward can be expressed, from (10) as<br> ![](images/miningprob_eq6.png)<br>
